...
Електронний посібник призначений для проведення лабораторного практикуму
з дисципліни ``Аналіз даних у біології та медицині'' для студентів
Освітньої програми
\href{http://cee.kdu.edu.ua/sites/default/files/opp_171_bak_2023.pdf}{``Технологія,
обладнання та виробництво електронної техніки''} спеціальності 171
``Електроніка''.
